 ...
 */
public class ShowQueueIdTest extends TestCase {
    ...
    public void testShowQueueId() {
        try {
            try {
                server.showQueueId(null, "admin");
                fail("null param succeeded.");
            } catch (BadParam bp) {
                // Success
            }
            try {
                server.showQueueId("fred", null);
